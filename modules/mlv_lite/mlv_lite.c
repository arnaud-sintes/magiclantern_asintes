...
unsigned int raw_rec_update_preview(unsigned int ctx)
{
	...
	: (shamem_read(0xC0F06804) == 0x93a011b || shamem_read(0xC0F06804) == 0x8d6011b || shamem_read(0xC0F06804) == 0x954011b || shamem_read(0xC0F06804) ==0x8f8011b) && RAW_IS_RECORDING ? RAW_PREVIEW_GRAY_ULTRA_FAST /* 1x3 binning mode test */
...
static unsigned int raw_rec_init()
{
    ...
    if (is_dir("A:/") && is_dir("B:/") && cam_5d3) cam_dualcard = cam_5d3; /* Add any new models later */
