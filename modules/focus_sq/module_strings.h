...
static char __module_string_a_value[] MODULE_STRINGS_SECTION = "Focus sequencing";
...
static char __module_string_d_value[] MODULE_STRINGS_SECTION = "Add accurate focus sequencing";
