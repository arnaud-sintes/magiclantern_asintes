...
int overclock_task_in_progress = 0;
...
{
	while (overclock_task_in_progress) // During overclocking, call msleep in loop until we finish. This appear to pause write/read without side effects
	{
		msleep(100);
	}
